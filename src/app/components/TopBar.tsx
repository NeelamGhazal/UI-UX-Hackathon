  ...
  return (
    <div className=" bg-violet-700 text-white py-2 text-sm flex items-center justify-center">
      ...
      <div className="w-full max-w-[1200px] flex items-center justify-between px-4">
        {/* Left Section */}
        <div className=" flex items-center justify-center gap-9 w-full sm:w-auto">
          {/* Email */}
          <a
            href="mailto:mhhasanul@gmail.com"
            className="ml-[110px] flex items-center gap-2 hover:text-gray-200"
          >
            <FaEnvelope />
          ...
          <a
            href="tel:1234567890"
            className="ml-[20px] whitespace-nowrap flex items-center gap-2 hover:text-gray-200"
          >
            <FaPhoneAlt />
        ...
        {/* Right Section */}
        <div className="mr-[98px] flex items-center justify-center gap-6 w-full sm:w-auto">
          {/* Language Selector */}
          <div
